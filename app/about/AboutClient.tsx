...
const linkIconMap: Record<string, ReactElement> = {
  github: <GitHubIcon />,
  qq: <QQIcon />,
  email: <Mail24Regular />,
  ...
  return (
    <div className="page-shell">
      ...
      <div className={styles.contentGrid}>
        <div className="stagger-in-item" style={{ height: "100%", ["--i" as string]: 0 }}>
        ...
        <div className="stagger-in-item" style={{ height: "100%", ["--i" as string]: 1 }}>
